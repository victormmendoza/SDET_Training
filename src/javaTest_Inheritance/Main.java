/*
 * 
Create a class Employee with following properties and functions
Properties:
	int empId
	String empName
	int total_leaves
...
Create two subclasses PermanentEmp and TemporaryEmp that extends Employee class 
with following properties and functions
...
Pf = 12% of basic
hra = 50% of basic
total_sal = basic + hra – pf - deduction
